...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="DIPA2.0-inference test (uncompleted collection)", name = 'mix losses (Resnet 50)')
    checkpoint_callback = ModelCheckpoint(dirpath='./models/mix losses (Resnet 50)/', save_last=True, monitor='val loss')
