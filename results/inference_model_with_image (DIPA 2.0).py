...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="DIPA2.0-inference test", name = 'Include prev manual label (resnet 50)')
    checkpoint_callback = ModelCheckpoint(dirpath='./models/Include prev manual label (resnet 50)/', save_last=True, monitor='val loss')
