...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="DIPA-inference", name = 'mix losses weighted metrics small dataset (resnet 50)')
    checkpoint_callback = ModelCheckpoint(dirpath='./models/mix losses weighted metrics small dataset (resnet 50)/', save_last=True, monitor='val loss')
