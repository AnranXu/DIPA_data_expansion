...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="DIPA-inference", name = 'mix losses without dropout (resnet18)')
    checkpoint_callback = ModelCheckpoint(dirpath='./models/test mix losses with augmentation (resnet18)/', save_last=True, monitor='val loss')
