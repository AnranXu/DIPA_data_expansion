...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="DIPA2.0-inference test", name = 'DIPA 1.0: 200 epoch (resnet 50)')
    ...
    trainer.fit(model, train_dataloaders = train_loader, val_dataloaders = val_loader, ckpt_path="./models/DIPA 1.0: 200 epoch (resnet 50)/last-v1.ckpt")
